...
export default class PhonePostpaidScreen extends Component {
  ...
  render() {
    ...
    let convertedStr = separateWithCommasTwoDecimals(this.state.amount / this.state.pricePerGoldGram);

    let additionalInfo = balance < this.state.amount ?
      <Text style={styles.error}>(Konversi Rupiah tidak cukup)</Text> : <Text></Text>;  
    ...
    return (
      <View style={styles.container}>     
        <View style={styles.rowBalance}>
          ...
          <View>
            <Text style={[styles.label, {textAlign: 'right'}]}>Saldo</Text>
            <Text style={isRedStyle}>{currentGoldStr} gram</Text>
          </View>          
        </View>   
        ...
        <View style={styles.formPayment}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between'}}>
            ...
            <View style={styles.confirmationRow}>
              <Text style={[styles.label, {textAlign: 'right'}]}>Jumlah</Text>
              <Text style={isRedStyle}>{convertedStr} gram</Text>
            </View>
          </View>
          <View style={styles.confirmationRow}>
        ...
        <View>{ this._selectConfirmationButton(isNotEnough) }</View>        
      </View>
    );
  }
}
